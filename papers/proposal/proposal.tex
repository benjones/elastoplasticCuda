...
Aside from that, much of the simulation should be relatively straightforward, although atomic operations or other synchronization methods may be necessary when calculating interactions between neighboring particles.
